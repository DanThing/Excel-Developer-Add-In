...
Dim errMsg As String
    Select Case Err.Number
        ...
        Case CustomError.Err2
            errMsg = "Unable to connect to Komunity." & "Please check your Internet connection." & vbNewLine & _
            errDetails
            
        Case CustomError.err3
            errMsg = "Unable to open File." & vbNewLine & errDetails
    ...
    End Select
    If Not Logger = Nothing Then
        LogError "[" & Err.Number & "] " & errMsg & " :: " & Err.Description
    Else
        MsgBox "ERROR: " & "[" & Err.Number & "] " & errMsg & " :: " & Err.Description
        SpeedUp False
        End
    End If
End Sub
